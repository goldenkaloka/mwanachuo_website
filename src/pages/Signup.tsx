                    ...
                    .insert([
                        {
                            ...
                            year_of_study: userType === "student" ? parseInt(yearOfStudy) : null,
                            current_semester: userType === "student" ? parseInt(semester) : null,
                            enrolled_course_id: userType === "student" ? courseId : null,
                    ...
                    <form onSubmit={handleSignup} className="space-y-4">
                        ...
                        {userType === "business" && (
                            <>
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-semibold text-foreground ml-1">Business Category</label>
                                    <select
                                        required
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-semibold text-foreground ml-1">University</label>
                            <div className="relative">
                        ...
                        {userType === "student" && (
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <label className="text-sm font-semibold text-foreground ml-1">Year of Study</label>
                                    <select
                                        required
                                        value={yearOfStudy}
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-semibold text-foreground ml-1">Semester</label>
                                    <select
                                        required
                                        value={semester}
                        ...
                        {userType === "student" && (
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-foreground ml-1">Course / Program</label>
                                <div className="relative">
